...
export const authApi = {
  registerStart: async (username: string, email: string): Promise<RegisterStartResponse> => {
    const response = await api.post<RegisterStartResponse>('/auth/register/start/', {
      username,
      email,
    });
  ...
  registerComplete: async (credential: any, challenge: string): Promise<AuthResponse> => {
  ...
  loginComplete: async (credential: any, challenge: string): Promise<AuthResponse> => {
